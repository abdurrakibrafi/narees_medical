...
import 'package:restaurent_discount_app/view/paitent_dashboard_view/auth_view/forget_password_view/create_new_password_view.dart';
      ...
      if (response.statusCode == 200) {
        ...
        if (responseBody['success'] == true) {
          if (responseBody['data'] != null &&
            ...
            await _storageService.write('tokens', otpToken);

            Get.to(() => CreateNewPassword());

            CustomToast.showToast(responseBody['message'], isError: false);
          } else {
            CustomToast.showToast("Token not found in response", isError: true);
          }
        } else {
          String errorMessage =
