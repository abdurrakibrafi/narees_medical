...
class AppointmentData {
  AppointmentData({
    ...
    required this.appointmentApplications,
    required this.nurse,
  });
  ...
  final List<dynamic> appointmentApplications;
  final dynamic nurse;
  ...
  factory AppointmentData.fromJson(Map<String, dynamic> json) {
    return AppointmentData(
      ...
      appointmentApplications: json["appointmentApplications"] == null
          ? []
          : List<dynamic>.from(json["appointmentApplications"]!.map((x) => x)),
      nurse: json["nurse"],
    );
  }
}
